"""
T16_abl_wedge.py — Table 15（tab:abl-wedge）核验
====================================================
...
CASES = {
    29: ("Full model",),
    30: ("w/o physics prior",),
    31: ("w/o graph correction",),
    32: ("w/o prior supervision",),
}

# 正文直接引用：(说明, 正文字面量, (case, 组, 量))
PROSE = [
    ("Case 29 Full model 频均 Sol", "21.645", (29, "Overall", "sol")),
    ("Case 29 Full model 频均 TL", "1.936", (29, "Overall", "tl")),
    ("Case 30 w/o prior 频均 Sol", "3022.705", (30, "Overall", "sol")),
    ("Case 30 w/o prior 频均 TL", "48.797", (30, "Overall", "tl")),
]
