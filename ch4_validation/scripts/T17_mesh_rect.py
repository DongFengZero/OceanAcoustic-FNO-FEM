"""
T17_mesh_rect.py — Table 17（tab:mesh-rect-mf）核验
====================================================
...
CASES = {
    33: ("R4", ("fig:mesh-rect", "fig:mesh-rect-a")),
    34: ("R7", ("fig:mesh-rect", "fig:mesh-rect-b")),
    35: ("R8", ("fig:mesh-rect", "fig:mesh-rect-c")),
}
...
def run():
    ...
    c.check(set(printed) == set(CASES), "tex 行 No. 覆盖 33-35",
            str(sorted(printed)))
